...
(ref:F3-densities) Category densities along F3 for the long and short vowels. Illustrating the effectiveness of vowel-intrinsic normalization (showing here Syrdal & Gopal in the center), compared to vowel-extrinsic normalization (showing here Lobanov, on the right) for the third formant. For reference, no normalization is also plotted.
