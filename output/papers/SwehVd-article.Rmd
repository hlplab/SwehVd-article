...
# To Do
  ...
  * Add REFS 
    * on noise (in footnote)
    * on listener integrating cues beyond F1 and F2
...
```{r confusion-matrix, fig.width=base.width*3.75, fig.height=base.height*3.75+.5, out.width='80%', fig.align='center', fig.cap="(ref:confusion-matrix)"}
...
```{r diff-matrix, fig.width=base.width*3.75, fig.height=base.height*2, out.width='80%', fig.align='center', fig.cap="(ref:diff-matrix)"}
