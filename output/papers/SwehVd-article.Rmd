...
```{r swe-vowels-all-cues, fig.width=base.width*4, fig.height=base.height*4+.5, fig.cap="(ref:swe-vowels-all-cues)"}
p.matrix.cues <- 
  d.SwehVd %>% 
  filter(Transcribed_vowel == "targeted", Word != "hädd") %>%
...
```{r separability-by-cue, fig.width= base.width * 3.5+.5, fig.height = base.height * 7, out.height='100%', out.width='100%', fig.align='center', fig.cap="(ref:separability-by-cue)"}
#cowplot::plot_grid(
...
#,
#  p.separability.Duration_by_quantity, nrow = 2, align = "hv", axis = "btlr", rel_heights = c(5/6, 1.5/6), rel_widths = c(5/6,.08), labels = c("", "E"))
```
...
```{r fig.width= base.width * 5, fig.height = base.height * 2.5, out.width='100%', fig.align='center', fig.cap="(ref:F3-densities-long)"}
d.SwehVd.forStudy.long %>% 
  ...
  geomtextpath::geom_textdensity(aes(label = category),
                                 size = 3,
                                 hjust = "ymax",
                                 vjust = -1, text_only = T, straight = T) +
