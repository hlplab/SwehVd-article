...
d.SwehVd.forStudy.long %>% 
  filter(Quantity == "long", fold_type == "test", Normalization.Type %in% c("no normalization (Hz)", "SyrdalGopal (Bark)")) %>%
  ggplot(
