...
```{r illustrate-normalization, fig.width=base.width*3+.5, fig.height=base.height*3, out.width='70%', fig.align='center', fig.cap="(ref:illustrate-normalization)"}
cowplot::plot_grid(
  legend,
  cowplot::plot_grid(
    cowplot::plot_grid(p.Eng.LiXie.raw, p.Eng.LiXie.Lobanov, labels = c("A", "B"), label_x = 0, vjust = 2, ncol = 2, align = "h"),
    cowplot::plot_grid(
...
```{r diphthongs, fig.width=base.width*2, fig.height=base.height*2, out.width='40%', fig.align='center', fig.cap="(ref:diphthongs)"}
d.SwehVd %>%
...
```{r swe-vowels, fig.width=base.width*2.5, fig.height=base.height*2.5, out.width='70%', fig.align='center', fig.cap="(ref:swe-vowels)"}
d.SwehVd %>% 
  filter(Transcribed_vowel == "targeted", Word != "hädd") %>%
  # Get the geometric mean F1-F2 across the five time points
