...
& & \cellcolor[HTML]{DDADAF}{{\multirow[c]{-4}{*}{\rotatebox{90}{standardizing}}}} & \cellcolor[HTML]{DDADAF}{(z-score)} & \cellcolor[HTML]{DDADAF}{} & \cellcolor[HTML]{DDADAF}{} & \cellcolor[HTML]{DDADAF}{} \\
...
```
(ref:gaussians) Visualising how an acoustic input can be an improbable instance of a category if each cue is considered separately (the marginal densities along the sides of the plot), but highly probable if considered relative to the joint distribution of cues. Ellipses show bivariate Gaussian 95% confidence interval of category means.
