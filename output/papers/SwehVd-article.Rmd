...
```{r illustrate-normalization, fig.width=base.width*2+.5, fig.height=base.height*2, out.width='100%', fig.align='center', fig.cap="(ref:illustrate-normalization)"}
cowplot::plot_grid(
  legend,
  cowplot::plot_grid(
    ...
    cowplot::plot_grid(
      ...
      NULL,
      p.Eng.LiXie.all.Lob, 
      align = "hv", labels = c("C", "", "D"), ncol = 1, rel_heights = c(1, .25, 1), hjust = -6, vjust = 1.9), 
