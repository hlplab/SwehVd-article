...
# To Do
  ...
  * Edits to introduction and discussion after meeting with Barreda.
    * limitations: evaluate against naturally produced tokens, might underestimate the effect of some normalization proceudures bcs everything tends to be correlated in natural speech.
  * Edits to claims of f0 not affecting vowel quality. Add Nearey & Barreda 2012 + Barreda 2020, for indirect effects of f0.
  * Clarifying the 0 degrees of freedom statement.
  * Edit table 4 so that it's clear what are synthesized stimuli and not.
  * Fix the OFS
  * Add REFS
    * missing refs
...
Since our goal is to obtain a reliable estimate of the formant values during the steady state of the vowel, we use only the three formant measurements extracted from the middle of the vowel (at 35%, 50%, and 65% into the vowel).^[An alternative approach would be to extract formants at e.g., 20 ms after onset and before offset of the vowel, instead of percentages. This might be a more suitable approach given that the long and short vowels systematically differ in duration. However, ]<!--AP: should this footnote be moved to the SwehVd section instead, where time points are first mentioned? Also, don't really know how to finish the sentence..-->
