...
d.Eng.LiXie <- 
  read_csv('../../../data/phonetic vowel statistics/English/Published databases/Li-Xie-2020/vowel_statistics/Li_Xie_2020_L1_vowels_statistics_general.csv') %>%
...
This paper has investigated the effect of low-level signal transformation/normalization of the acoustic input on the vowel system of Stockholm Swedish, both in terms of its effects on category separability, and its predicted consequences for perception. The evaluation of the 15 different normalization accounts against the dense vowel space of Swedish, has allowed us to assess whether the same normalization accounts that work well for smaller systems, work equally well for the more complex systems. Investigating a language with quantity distinctions, also make it possible to bridge the literature on vowel-specific accounts and general normalization accounts [such as C-CuRE; @mcmurray-jongman2011], and to extend previous research that primarily has focused on the first two (or three) formants. 

The speech materials used was a subset of the SwehVd database, presented and released in this paper, and the following methods were used for evaluation. In Study I, we compared the reduction of within-category variability relative to between-category variability by calculating a separability index (i.e., an F-statistics). Using this type of metric facilitates comprehension to previous studies... In Study II, we assessed the predicted consequences for perception by training ideal observer models on the vowel data in different normalization spaces, under different assumptions about the relevant cues. This approach comes with simplifying assumptions, one being that categories can be represented as Gaussians... Another being that we assume uniform category priors... The advantage of the model in having 0 degrees of freedom, strikes a middle ground between less parsimonious models such as exemplar models, and more parsimonious, such as models of cue integration... All of these assumptions can, however, be revisited as code is provided in the SI/OFS...

The results from Study I showed that the same type of accounts that have been proven successful in previous evaluations, are also successful in improving category separability on Swedish vowels. The reduction in variability, or rather, the increase in separability in this study, seem to be equally large as those reported by @disner1980 for the other languages in her cross-linguistic study. Furthermore, here, simple centering performs as good, or actually better, for Swedish as they did for the other languages in her study. In conclusion, it might well be the case that the (somewhat) unexpected/diverging <!-- change word--> results for Swedish in @disner1980's study, could be an effect of the nature of the dataset used <!-- AP: or male vs female--> However, ....<!-- AP: check results om Labov, Barreda/Nearey, that also used Fstats-->. 

Study II indicated that psycho-acoustic scale transformations alone does not make as strong predictions for perception as does normalization accounts. Simple centering perform very well, especially when more cues are included. As models become more human-like, they perform better, which indicates that they might make up a plausible candidate for a mechanism supporting inter-talker perception. But, for that we need perceptual data, which we will include in future studies... 
