...
```{r separability-by-cue, fig.width= base.width * 4, fig.height = base.height * 7, fig.align='center', fig.cap="(ref:separability-by-cue)"}
#cowplot::plot_grid(
