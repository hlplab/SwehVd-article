...
levels.normalization.noSG = c("r_Hz", "r_Mel", "r_Bark", "r_ERB", "r_semitones", "Miller_log", "CCuRE_Hz", "CCuRE_Mel", "CCuRE_Bark", "CCuRE_ERB", "CCuRE_semitones", "Nearey1_log", "Nearey2_log", "Gerstman_Hz", "Lobanov_Hz")
...
labels.normalization.noSG = c("no normalization (Hz)", "transformed (Mel)", "transformed (Bark)", "transformed (ERB)","transformed (semitones)", "Miller (log)", "C-CuRE (Hz)", "C-CuRE (Mel)", "C-CuRE (Bark)", "C-CuRE (ERB)", "C-CuRE (semitones)", "Nearey1 (log)", "Nearey2 (log)", "Gerstman (Hz)", "Lobanov (Hz)")
